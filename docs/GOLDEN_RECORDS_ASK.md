...
| Without Golden Records | With Golden Records |
|------------------------|---------------------|
| Algorithm learns from whoever IT imports first | Algorithm learns from JL's actual taste |
| Search results reflect generic "good" | Search results reflect our aesthetic |
| 200+ hours of correction later | 30 minutes of input now |

**The math:** 15 Golden Records now = months of calibration saved later.
...
|----------|---------------|--------|
| Cinematographers | 4 | 6-8 |
| Motion Designers | 1 | 3-4 |
| VFX Artists | 1 | 2-3 |
| Animators | 1 | 2-3 |
| Colorists | 1 | 2-3 |
| Directors | 1 | 2-3 |
| Sound Designers | 1 | 1-2 |

**Total needed:** ~10-15 more names

---

## Current Golden Records (For Reference)
...
**Option A:** Reply to Dan's email with a list  
**Option B:** Add names to this shared doc: [LINK TBD]  
**Option C:** 15-minute call with IT to talk through names
...
| Milestone | Date |
|-----------|------|
| Golden Records submitted | Within 2 weeks |
| Loaded into system | Same day as submission |
| Improved search results | Immediate |

---

## Questions?

Contact Dan (Strategy) or Charley (IT).
